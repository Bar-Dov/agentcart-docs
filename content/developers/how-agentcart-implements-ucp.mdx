...
AgentCart exposes a JSON-RPC 2.0 endpoint at `/api/ucp/{slug}/mcp` for agents using the Model Context Protocol. See [MCP Transport](/docs/developers/mcp-transport).
